...
def generate_launch_description():
    ...
    gz_sim_server = IncludeLaunchDescription(
        ...
        launch_arguments={
            "gz_args": " -v4 -s -r " + os.path.join(pkg_description, 'world', "landmark_ambiguous_x_w_poses_a_lines.world"),
            "gz_version": "8"
        }.items(),
    )
    ...
    gz_sim_gui = IncludeLaunchDescription(
        ...
        launch_arguments={
            "gz_args": f"-v4 -g " + os.path.join(pkg_description, 'world', "landmark_ambiguous_x_w_poses_a_lines.world"),
            "gz_version": "8"
        }.items(),
    )
